      ...
      <div class="inner_container">
        ...
        <nav id="sidebar">
          ...
          <div class="sidebar_blog_2">
            ...
            <ul class="list-unstyled components">
              <li class="active">
                <a href="admin.php"
                  ><i class="fa fa-dashboard iColor"></i>
                  <span>Dashboard</span></a
                >
              </li>
              <li class="active">
                <a href="admin_users.php"
                  ><i class="fa fa-users iColor"></i> <span>Users</span></a
                >
              </li>
              <li class="active">
                <a href="admin_App.php"
                  ><i class="fa fa-table-list iColor"></i>
              ...
              <li class="active">
                <a href="home.php"
                  ><i class="fa-solid fa-right-from-bracket iColor"></i>
                  <span>Log Out</span></a
                >
              </li>
            </ul>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
              <div class="full">
                ...
                <div
                  ...
                  style="font-size: 40px; color: #911439"
                >
                  The Style Studio
                </div>
              </div>
          ...
          <div class="text-center">
            <div style="font-size:100px;color:black">WELCOME</div>
            <div style="font-size: 30px;">Check Your Growth</div>
          </div>
        </div>
      </div>
    </div>
